...
2. Then open 5 terminals, 2 in Group_28 and 3 in each of the peer1/2/3 directories.

3. Then to generate the executable files (also already there) use the following : (compilation step)
	a. Terminal 1: Group_28$ gcc -o relay_server relay_server.c
	b. Terminal 2: Group_28$ gcc -o peer_client peer_client.c
	c. Terminal 3: Group_28/peer1$ gcc -o peer1 peer_node.c
	d. Terminal 4: Group_28/peer2$ gcc -o peer2 peer_node.c
	e. Terminal 5: Group_28/peer3$ gcc -o peer3 peer_node.c

4. To execute do the following (in order).
	a. Terminal 1: Group_28$ ./relay_server 8000
	b. Terminal 3: Group_28/peer1$ ./peer1 0.0.0.0 8000
	c. Terminal 4: Group_28/peer2$ ./peer2 0.0.0.0 8000
	d. Terminal 5: Group_28/peer3$ ./peer3 0.0.0.0 8000
	e. Terminal 2: Group_28$ ./peer_client 0.0.0.0 8000
